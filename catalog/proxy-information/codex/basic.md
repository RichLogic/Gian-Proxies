...
这是 2026-09-20 Catalog 1.7.0 的目标，不是本机安装状态：Proxy **0.3.1**，Runtime **0.153.4**。

目标位置样例：

```text
<dataDir>/runtimes/codex/0.153.4/<artifact-sha256>/bin/codex
```
...
- Codex 的 Proxy 版本、Runtime 版本与 Gian App 版本不是同一个版本号。
